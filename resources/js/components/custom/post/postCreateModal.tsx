...
const PostCreateModal = ({isOpen, onIsOpenChange, postForEdit, groups, activeGroupId, onCreate, onUpdate}: PostModalProps) => {
    // Content
    const [content, setContent] = useState<string>(postForEdit?.content || '');
    ...
    return (
        ...
        >
            <DialogContent className="w-full rounded-2xl sm:max-w-[800px] p-4 bg-secondary overflow-y-auto max-h-[90vh]">
                <Form
